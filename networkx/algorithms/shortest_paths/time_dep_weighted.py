...
__all__ = ['tim_dep_dijkstra_path',
           'tim_dep_dijkstra_path_length',
           'bidirectional_dijkstra',
           'tim_dep_single_source_dijkstra',
           'tim_dep_single_source_dijkstra_path',
           'tim_dep_single_source_dijkstra_path_length',
           'tim_dep_multi_source_dijkstra',
           'tim_dep_multi_source_dijkstra_path',
           'tim_dep_multi_source_dijkstra_path_length',
           'tim_dep_all_pairs_dijkstra',
           'tim_dep_all_pairs_dijkstra_path',
           'tim_dep_all_pairs_dijkstra_path_length',
           'tim_dep_dijkstra_predecessor_and_distance']
...
def tim_dep_dijkstra_path(G, source, target, time_of_request, weight='weight', timetable='departure_time'):  # LY: added initial time of request as argument
  ...
  """
  (length, path) = tim_dep_single_source_dijkstra(G, source, time_of_request, target=target, weight=weight, timetable=timetable)   # LY: added initial time of request as argument
  return path
  print('ok')


def tim_dep_dijkstra_path_length(G, source, target, time_of_request, weight='weight', timetable='departure_time'):
  ...
  length = _tim_dep_dijkstra(G, source, time_of_request, weight, timetable, target=target)
  try:
...
def tim_dep_single_source_dijkstra_path(G, source, cutoff=None, weight='weight'):
  ...
  """
  return tim_dep_multi_source_dijkstra_path(G, {source}, cutoff=cutoff,
                                            weight=weight)


def tim_dep_single_source_dijkstra_path_length(G, source, cutoff=None,
                                               weight='weight'):
  ...
  """
  return tim_dep_multi_source_dijkstra_path_length(G, {source}, cutoff=cutoff,
                                                   weight=weight)


def tim_dep_single_source_dijkstra(G, source, time_of_request, target=None, cutoff=None, weight='weight', timetable='departure_time'):        # LY: added initial time of request as argument
  ...
  """
  return tim_dep_multi_source_dijkstra(G, {source}, time_of_request, cutoff=cutoff, target=target, weight=weight, timetable=timetable)     # LY: added initial time of request as argument


def tim_dep_multi_source_dijkstra_path(G, sources, cutoff=None, weight='weight'):
  ...
  """
  length, path = tim_dep_multi_source_dijkstra(G, sources, cutoff=cutoff,
                                               weight=weight)
  return path


def tim_dep_multi_source_dijkstra_path_length(G, sources, cutoff=None,
                                              weight='weight'):
  ...
  weight = _weight_function(G, weight)
  return _tim_dep_dijkstra_multisource(G, sources, weight, cutoff=cutoff)


def tim_dep_multi_source_dijkstra(G, sources, time_of_request, target=None, cutoff=None, weight='weight', timetable='departure_time'):        # LY: added initial time of request as argument
  ...
  dist = _tim_dep_dijkstra_multisource(G, sources, time_of_request, weight, timetable, paths=paths, cutoff=cutoff, target=target)      # LY: added initial time of request as argument
  if target is None:
    return (dist, paths)
  try:
...
def _tim_dep_dijkstra(G, source, time_of_request, weight, timetable, pred=None, paths=None, cutoff=None,
                      target=None):
  ...
  """
  return _tim_dep_dijkstra_multisource(G, [source], time_of_request, weight, timetable, pred=pred, paths=paths,
                                       cutoff=cutoff, target=target)


def _tim_dep_dijkstra_multisource(G, sources, time_of_request, weight, timetable, pred=None, paths=None, cutoff=None, target=None):        # LY: added initial time of request as argument
  ...
  for source in sources:
    ...
    seen[source] = 0
    push(fringe, (time_of_request, next(c), source))                      # LY: added initial time of request as argument
  while fringe:
    (d, _, v) = pop(fringe)
    if v in dist:
    ...
    for u, e in G_succ[v].items():
      ...
      vu_dist = dist[v] + plat_wait_time + cost
...
def tim_dep_dijkstra_predecessor_and_distance(G, source, cutoff=None, weight='weight'):
...
def tim_dep_all_pairs_dijkstra(G, cutoff=None, weight='weight'):
...
def tim_dep_all_pairs_dijkstra_path_length(G, cutoff=None, weight='weight'):
...
def tim_dep_all_pairs_dijkstra_path(G, cutoff=None, weight='weight'):
